...
function reset(){form.reset();id.value="";sort.value="0";active.checked=true;dismissible.checked=true;showOnce.checked=false;ctaText.value="";ctaUrl.value="";preview.hidden=true;preview.innerHTML="";save.textContent="Save announcement";image.value="";}
